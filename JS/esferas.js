    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            const treeProducts = products.filter(product => 
                product.category.toLowerCase().includes('esfera') ||
                product.category.toLowerCase() === 'esferas'
            );

            console.log('🌲 Productos de esferas encontrados:', treeProducts.length);
            console.log('🌲 Detalles de productos de esferas', treeProducts);
