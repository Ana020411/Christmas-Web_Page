    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            const treeProducts = products.filter(product => 
                product.category.toLowerCase().includes('luces') ||
                product.category.toLowerCase() === 'luces'
            );

            console.log('🌲 Productos de luces encontrados:', treeProducts.length);
            console.log('🌲 Detalles de productos de luces', treeProducts);
